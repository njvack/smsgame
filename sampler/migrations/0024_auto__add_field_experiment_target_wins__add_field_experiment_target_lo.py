...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.target_wins'
        db.add_column('sampler_experiment', 'target_wins', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # Adding field 'Experiment.target_losses'
        db.add_column('sampler_experiment', 'target_losses', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.target_wins'
        db.delete_column('sampler_experiment', 'target_wins')

        # Deleting field 'Experiment.target_losses'
        db.delete_column('sampler_experiment', 'target_losses')
    ...
    models = {
        ...
        'sampler.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'ppkssmcfmh'", 'unique': 'True', 'max_length': '50', 'db_index': 'True'})
        },

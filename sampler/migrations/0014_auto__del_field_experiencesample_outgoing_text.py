...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExperienceSample.outgoing_text'
        db.delete_column('sampler_experiencesample', 'outgoing_text_id')


    def backwards(self, orm):
        
        # Adding field 'ExperienceSample.outgoing_text'
        db.add_column('sampler_experiencesample', 'outgoing_text', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sampler.OutgoingTextMessage'], null=True, blank=True), keep_default=False)

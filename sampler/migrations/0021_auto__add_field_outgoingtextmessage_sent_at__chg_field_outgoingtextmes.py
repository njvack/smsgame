...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OutgoingTextMessage.sent_at'
        db.add_column('sampler_outgoingtextmessage', 'sent_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 22, 17, 4, 23, 92998)), keep_default=False)

        # Changing field 'OutgoingTextMessage.participant'
        db.alter_column('sampler_outgoingtextmessage', 'participant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sampler.Participant']))


    def backwards(self, orm):
        
        # Deleting field 'OutgoingTextMessage.sent_at'
        db.delete_column('sampler_outgoingtextmessage', 'sent_at')

        # Changing field 'OutgoingTextMessage.participant'
        db.alter_column('sampler_outgoingtextmessage', 'participant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sampler.Participant'], null=True))

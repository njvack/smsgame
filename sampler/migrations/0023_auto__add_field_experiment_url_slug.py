...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.url_slug'
        db.add_column('sampler_experiment', 'url_slug', self.gf('django.db.models.fields.SlugField')(default='cpgttbjdgq', unique=True, max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.url_slug'
        db.delete_column('sampler_experiment', 'url_slug')
    ...
    models = {
        ...
        'sampler.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'dthdfskrsh'", 'unique': 'True', 'max_length': '50', 'db_index': 'True'})
        },
        ...
        'sampler.hilowgame': {
            ...
            'answered_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'correct_guess': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),

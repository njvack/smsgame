...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiLowGame.deleted_at'
        db.add_column('sampler_hilowgame', 'deleted_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'GamePermission.deleted_at'
        db.add_column('sampler_gamepermission', 'deleted_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExperienceSample.deleted_at'
        db.add_column('sampler_experiencesample', 'deleted_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiLowGame.deleted_at'
        db.delete_column('sampler_hilowgame', 'deleted_at')

        # Deleting field 'GamePermission.deleted_at'
        db.delete_column('sampler_gamepermission', 'deleted_at')

        # Deleting field 'ExperienceSample.deleted_at'
        db.delete_column('sampler_experiencesample', 'deleted_at')
    ...
    models = {
        ...
        'sampler.hilowgame': {
            ...
            'answered_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'correct_guess': ('django.db.models.fields.IntegerField', [], {'default': '9'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),

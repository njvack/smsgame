...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExperienceSample.negative_emotion'
        db.delete_column(u'sampler_experiencesample', 'negative_emotion')

        # Deleting field 'ExperienceSample.positive_emotion'
        db.delete_column(u'sampler_experiencesample', 'positive_emotion')

        # Adding field 'ExperienceSample.positive_you'
        db.add_column(u'sampler_experiencesample', 'positive_you',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceSample.negative_you'
        db.add_column(u'sampler_experiencesample', 'negative_you',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceSample.positive_other'
        db.add_column(u'sampler_experiencesample', 'positive_other',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceSample.negative_other'
        db.add_column(u'sampler_experiencesample', 'negative_other',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExperienceSample.negative_emotion'
        db.add_column(u'sampler_experiencesample', 'negative_emotion',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceSample.positive_emotion'
        db.add_column(u'sampler_experiencesample', 'positive_emotion',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ExperienceSample.positive_you'
        db.delete_column(u'sampler_experiencesample', 'positive_you')

        # Deleting field 'ExperienceSample.negative_you'
        db.delete_column(u'sampler_experiencesample', 'negative_you')

        # Deleting field 'ExperienceSample.positive_other'
        db.delete_column(u'sampler_experiencesample', 'positive_other')

        # Deleting field 'ExperienceSample.negative_other'
        db.delete_column(u'sampler_experiencesample', 'negative_other')
    ...
    models = {
        u'sampler.experiencesample': {
            ...
            'negative_other': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'negative_you': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'positive_other': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'positive_you': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'sampler.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'pmdkvvvbmk'", 'unique': 'True', 'max_length': '50'})
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiLowGame.result_reported_at'
        db.add_column('sampler_hilowgame', 'result_reported_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiLowGame.result_reported_at'
        db.delete_column('sampler_hilowgame', 'result_reported_at')
    ...
    models = {
        ...
        'sampler.hilowgame': {
            ...
            'answered_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'correct_guess': ('django.db.models.fields.IntegerField', [], {'default': '7'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),

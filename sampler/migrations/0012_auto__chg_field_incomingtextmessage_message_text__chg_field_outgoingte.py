...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IncomingTextMessage.message_text'
        db.alter_column('sampler_incomingtextmessage', 'message_text', self.gf('django.db.models.fields.CharField')(max_length=160))

        # Changing field 'OutgoingTextMessage.message_text'
        db.alter_column('sampler_outgoingtextmessage', 'message_text', self.gf('django.db.models.fields.CharField')(max_length=160))


    def backwards(self, orm):
        
        # Changing field 'IncomingTextMessage.message_text'
        db.alter_column('sampler_incomingtextmessage', 'message_text', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'OutgoingTextMessage.message_text'
        db.alter_column('sampler_outgoingtextmessage', 'message_text', self.gf('django.db.models.fields.CharField')(max_length=140))

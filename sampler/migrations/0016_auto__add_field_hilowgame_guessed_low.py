...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiLowGame.guessed_low'
        db.add_column('sampler_hilowgame', 'guessed_low', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiLowGame.guessed_low'
        db.delete_column('sampler_hilowgame', 'guessed_low')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HiLowGame'
        db.create_table('sampler_hilowgame', (
            ...
            ('correct_guess', self.gf('django.db.models.fields.IntegerField')(default=2)),
        ))
        db.send_create_signal('sampler', ['HiLowGame'])

        # Adding model 'GamePermission'
        db.create_table('sampler_gamepermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sampler.Participant'])),
        ...
        db.send_create_signal('sampler', ['GamePermission'])


    def backwards(self, orm):
        
        # Deleting model 'HiLowGame'
        db.delete_table('sampler_hilowgame')

        # Deleting model 'GamePermission'
        db.delete_table('sampler_gamepermission')
    ...
    models = {
        ...
        'sampler.gamepermission': {
            'Meta': {'object_name': 'GamePermission'},
            'answered_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incoming_text': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sampler.IncomingTextMessage']", 'null': 'True', 'blank': 'True'}),
        ...
        'sampler.hilowgame': {
            'Meta': {'object_name': 'HiLowGame'},
            'answered_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'correct_guess': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incoming_text': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sampler.IncomingTextMessage']", 'null': 'True', 'blank': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sampler.Participant']"}),

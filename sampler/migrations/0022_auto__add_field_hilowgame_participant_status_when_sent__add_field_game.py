...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiLowGame.participant_status_when_sent'
        db.add_column('sampler_hilowgame', 'participant_status_when_sent', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'GamePermission.participant_status_when_sent'
        db.add_column('sampler_gamepermission', 'participant_status_when_sent', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'ExperienceSample.participant_status_when_sent'
        db.add_column('sampler_experiencesample', 'participant_status_when_sent', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiLowGame.participant_status_when_sent'
        db.delete_column('sampler_hilowgame', 'participant_status_when_sent')

        # Deleting field 'GamePermission.participant_status_when_sent'
        db.delete_column('sampler_gamepermission', 'participant_status_when_sent')

        # Deleting field 'ExperienceSample.participant_status_when_sent'
        db.delete_column('sampler_experiencesample', 'participant_status_when_sent')
    ...
    models = {
        ...
        'sampler.hilowgame': {
            ...
            'answered_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'correct_guess': ('django.db.models.fields.IntegerField', [], {'default': '6'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),

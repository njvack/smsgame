...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskDay.status'
        db.add_column('sampler_taskday', 'status', self.gf('django.db.models.fields.CharField')(default='waiting', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TaskDay.status'
        db.delete_column('sampler_taskday', 'status')
